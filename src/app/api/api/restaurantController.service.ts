...
// @ts-ignore
import { RestaurantsFilter } from '../model/restaurantsFilter';
// @ts-ignore
import { RestaurantsList } from '../model/restaurantsList';
// @ts-ignore
import { RestaurantsStatisticFilter } from '../model/restaurantsStatisticFilter';
// @ts-ignore
import { RestaurantsStatisticList } from '../model/restaurantsStatisticList';
// @ts-ignore
...
export class RestaurantControllerService extends BaseService {
     ...
     * @param restaurantsFilter 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getRestaurantsByFilter(restaurantsFilter?: RestaurantsFilter, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<RestaurantsList>;
    public getRestaurantsByFilter(restaurantsFilter?: RestaurantsFilter, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<RestaurantsList>>;
    public getRestaurantsByFilter(restaurantsFilter?: RestaurantsFilter, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<RestaurantsList>>;
    public getRestaurantsByFilter(restaurantsFilter?: RestaurantsFilter, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
    ...
    /**
     * Get restaurants statistic by filter
     * @param restaurantsStatisticFilter 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getRestaurantsStatisticByFilter(restaurantsStatisticFilter?: RestaurantsStatisticFilter, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<RestaurantsStatisticList>;
    public getRestaurantsStatisticByFilter(restaurantsStatisticFilter?: RestaurantsStatisticFilter, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<RestaurantsStatisticList>>;
    public getRestaurantsStatisticByFilter(restaurantsStatisticFilter?: RestaurantsStatisticFilter, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<RestaurantsStatisticList>>;
    public getRestaurantsStatisticByFilter(restaurantsStatisticFilter?: RestaurantsStatisticFilter, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/api/restaurant/statistic`;
        return this.httpClient.request<RestaurantsStatisticList>('put', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: restaurantsStatisticFilter,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: localVarHeaders,
                observe: observe,
