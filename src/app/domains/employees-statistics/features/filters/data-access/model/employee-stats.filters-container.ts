...
import {EmployeeStatsPositionFilterModel} from "./employee-stats-position-filter.model";
...
export class EmployeeStatsFiltersContainer extends ServerSideFiltersContainer<EmployeeStatistic> {
  ...
  readonly position = this.addFilterModel(new EmployeeStatsPositionFilterModel());
}
